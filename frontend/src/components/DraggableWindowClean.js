...
const WebDraggableWindow = ({ 
  ...
  }, [isResizing, resizeStart, isLocked]);
      ...
      {!isMinimized && !isLocked && (
        <div
          ...
          style={{
            ...
            cursor: 'se-resize',
            userSelect: 'none',
            backgroundColor: isResizing ? 'rgba(0,102,255,0.1)' : 'transparent',
...
// Mobile-specific draggable window component (PanResponder implementation)
